function deleteTask(event) {                                                //chama o evento para apagar um item da lista
    ...
    let listElement = document.getElementById('ul');                        //cria uma variável que recebe o elemento 'ul' do html como valor
    let taskToDelete = buttonTarget.parentNode;                             //cria uma variável que recebe como valor o retorno da variável-pai 'buttonTarget'
    listElement.removeChild(taskToDelete);                                  //coloca um método na variável 'listElement' para remover um elemento filho resultado da variável 'taskToDelete'
}